...
$select='<option value="-1" selected="">Seleccione Un Archivo</option>';
                $sql="select * from ".__BASE_DATOS__.".archivos where year(fechacarga)=".$_POST['ano']." and month(fechacarga)=".$_POST['mes']." and tipoarchivo=4 and tipocarga='".$_POST['TipoCarga']."' order by id desc";
