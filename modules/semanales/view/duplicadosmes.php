    ...
    <div class="panel-body">
        <table id="example" style="font-size: 10px;" class="display" width="100%" cellspacing="0">
            ...
            <tbody>
                ...
                $sql = "insert into ".__BASE_DATOS__.".duplicados select stm.expediente,null from ".__BASE_DATOS__.".semanales_temporal stm
                    inner join ".__BASE_DATOS__.".semanales_historico shi on shi.expediente=stm.expediente
group by concat(stm.patente,stm.fecservicio,stm.codservicio,stm.cod_colectivo,stm.cod_contrato,stm.clasif) having count(*)>1;"; 

                 mysql_query($sql, $conn->consulta($sql));
                 $sql="select * from ".__BASE_DATOS__.".semanales_historico shi inner join ".__BASE_DATOS__.".duplicados  du on du.expediente=shi.expediente ";
