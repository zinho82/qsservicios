    ...
    <div class="panel panel-primary">
        ...
        <div class="panel-body">
            <form id="FormAsignar" method="post">
                ...
                <input id="EjQuita" name="EjQuita" class="form-control" value="<?php echo $_GET['id'] ?>">
                ...
                <input type="text" id="AccionReg" name="AccionReg"  value="<?php echo $_GET['acc'] ?>">
                                <input type="text" id="codCamReg" name="codCamReg" value="<?php echo $_GET['cod'] ?>">
                                <input type="text" id="Cantidad" name="Cantidad" value="" placeholder="Cantidad a asignar max <?php echo $_GET['reg']?>" >
                                <input type="text" id="Campanas" name="Campanas" value="<?php echo $_GET['c'] ?>">
