 ...
 */
echo $sql="update ".$_SESSION['campana']['bd'].".$tabla set id_acceso=".$_POST['EjAsigna']." where cod_carga='".$_POST['codCamReg']."' and id_acceso=".$_POST['EjQuita']."  limit ".$_POST['Cantidad'];
