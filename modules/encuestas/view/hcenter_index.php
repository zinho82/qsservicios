...
<div class="panel panel-primary">
    ...
    <table class="table" id='ListaEncuestas'>
        ...
        <tbody >
            <?php
              $sql = "select * from qsschile_qs_encuestas.qs_encuestascli_sodimac_emp  sm where sm.id_acceso=".$_SESSION['usuario']['id']." and sm.estado!=30  and id_encuesta!=0 and datediff(date(now()),date(sm.fec_termino))>0  and sm.num_post<6";
