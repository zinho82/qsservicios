...
//		$strsql="select id_postulante,Nombres,ape_paterno,ape_materno from cv_postulantes where estado=1 order by Nombres";
		...
		$strsql="select distinct cod_carga, a.id_formato, formato, id_encuesta, date_format(a.fec_ingreso,'%d-%m-%Y') as fec_ingreso, 
				...
				e.estado 
				from qs_encuestascli_sodimac_eco a 
...
//		echo $strsql;
		...
		if ($result)
		{
			...
			{
				echo "<tr>";
				echo "<td align=\"center\"><a href=\"EditarEncuestaSODI_ECO.php?id_encuesta=".$row['id_encuesta']."&id_formato=".$row['id_formato']."&estado=".$estado."\"><img src=\"../imagenes/lupa.jpg\" border=\"0\" width=\"30\" /></a></td>";
