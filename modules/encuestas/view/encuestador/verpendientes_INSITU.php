...
<hr/>
	...
	<tr>
		...
		<h2>Encuestas Pendientes de Ingreso AUDITORIAS IN SITU</h2>
...
//		$strsql="select id_postulante,Nombres,ape_paterno,ape_materno from cv_postulantes where estado=1 order by Nombres";
		...
		$strsql="select distinct cod_carga, a.id_formato, formato, id_encuesta, date_format(a.fec_ingreso,'%d-%m-%Y') as fec_ingreso, 
				Rut_cli, Nombre_cli, a.Provee_Sini, 
				e.estado, b.direccion, b.telefono, b.url   
				from qs_encuestascli_insitu a left join qs_prestadores_insitu b on a.provee_sini = b.provee_sini
...
//		echo $strsql;
		...
		if ($result)
		{
			...
			echo "<th align=\"center\" class=\"texto_normal\">Nombre Proveedor</th>";
//			echo "<th align=\"center\" class=\"texto_normal\">Dirección</th>";
//			echo "<th align=\"center\" class=\"texto_normal\">Teléfono</th>";
			echo "<th align=\"center\" class=\"texto_normal\">Nombre</th>";
			echo "<th align=\"center\" class=\"rounded-q4\">Estado</th></thead></tr><tbody>";
			while($row = mysql_fetch_array($result))
			{
				echo "<tr>";
				echo "<td align=\"center\"><a href=\"EditarEncuestaINSITU.php?id_encuesta=".$row['id_encuesta']."&id_formato=".$row['id_formato']."&estado=".$estado."\"><img src=\"../imagenes/lupa.jpg\" border=\"0\" width=\"30\" /></a></td>";
				...
				echo "<td align=\"center\" class=\"texto_normal\">".$row['Rut_cli']."</td>";
//				echo "<td align=\"center\" class=\"texto_normal\">".$row['Provee_Sini']."</td>";
				if ($row['url'] <> "") {
					echo "<td align=\"center\"><a href=\"VeGoogle.php?direccion=".$row['direccion']."&telefono=".$row['telefono']."\">".$row['Provee_Sini']."</a></td>";
					}
				else {
					echo "<td align=\"center\">".$row['Provee_Sini']."</td>";
				}
//				echo "<td align=\"center\"><a href=\"VeGoogle.php?direccion=direccion 123&telefono=telefono456\">".$row['Provee_Sini']."</a></td>";
//				echo "<td align=\"center\" class=\"texto_normal\">".$row['direccion']."</td>";
//				echo "<td align=\"center\" class=\"texto_normal\">".$row['telefono']."</td>";
				echo "<td align=\"center\" class=\"texto_normal\">".$row['Nombre_cli']."</td>";
