...
function combosregion(str1,str2,destino,IdCombo)
{
	ajaxcombos("../funciones/combos2.php?Id="+IdCombo+"&valor1="+str1+"&valor2="+str2,destino,IdCombo)
}

function combosprovincia(str1,str2,destino,IdCombo)
{
	ajaxcombos("../funciones/combos2.php?Id="+IdCombo+"&valor1="+str1+"&valor2="+str2,destino,IdCombo)
}
...
{
	ajaxcombos("../funciones/combos2.php?Id="+IdCombo+"&valor1="+str1+"&valor2="+str2+"&valor3="+str3,destino,IdCombo)
}

function cambiaregion1()
{
	eventocheck("../funciones/combos2.php?Id=0&valor1=2","divmismaprovincia1")
	eventocheck("../funciones/combos2.php?Id=0&valor1=3","divmismacomuna1")
...
function cambiarprovincia1()
{
	...
	eventocheck("../funciones/combos2.php?Id=0&valor1=1",destino)
	document.ingreso.mismacomuna1.checked=true;
}
...
function modificaprovincia1(check,destino,IdCombo)
{
	...
	{
		eventocheck("../funciones/combos2.php?Id=0&valor1=2",destino)
	}
}
function modificacomuna1(check,destino,IdCombo)
{
	...
	{
		eventocheck("../funciones/combos2.php?Id=0&valor1=3",destino)
	}
}
