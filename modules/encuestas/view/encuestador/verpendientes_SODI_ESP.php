...
<hr/>
	...
	<tr>
		...
		<h2>Encuestas Pendientes de Ingreso SODIMAC ESPECIALISTA</h2>
...
//		$strsql="select id_postulante,Nombres,ape_paterno,ape_materno from cv_postulantes where estado=1 order by Nombres";
		...
		$strsql="select distinct cod_carga, a.id_formato, formato, id_encuesta, date_format(a.fec_ingreso,'%d-%m-%Y') as fec_ingreso, 
				TIPO_CLIENTE, Nombre, Direccion, FONO_AT1, FONO_AT2, FONO_AT3, FONO_AT4, FONO_AT5, Num_Celular, 
				e.estado 
				from qs_encuestascli_sodimac_esp a 
...
//		echo $strsql;
		...
		if ($result)
		{
			...
			echo "<th align=\"center\" class=\"texto_normal\">TIPO_CLIENTE</th>";
			echo "<th align=\"center\" class=\"texto_normal\">Nombre</th>";
			echo "<th align=\"center\" class=\"texto_normal\">Direccion</th>";
			echo "<th align=\"center\" class=\"texto_normal\">FONO_AT1</th>";
			echo "<th align=\"center\" class=\"texto_normal\">FONO_AT2</th>";
			echo "<th align=\"center\" class=\"texto_normal\">FONO_AT3</th>";
			...
			{
				echo "<tr>";
				echo "<td align=\"center\"><a href=\"EditarEncuestaSODI_ESP.php?id_encuesta=".$row['id_encuesta']."&id_formato=".$row['id_formato']."&estado=".$estado."\"><img src=\"../imagenes/lupa.jpg\" border=\"0\" width=\"30\" /></a></td>";
				...
				echo "<td align=\"center\" class=\"texto_normal\">".$row['TIPO_CLIENTE']."</td>";
				echo "<td align=\"center\" class=\"texto_normal\">".$row['Nombre']."</td>";
				echo "<td align=\"center\" class=\"texto_normal\">".$row['Direccion']."</td>";
				echo "<td align=\"center\" class=\"texto_normal\">".$row['FONO_AT1']."</td>";
				echo "<td align=\"center\" class=\"texto_normal\">".$row['FONO_AT2']."</td>";
				echo "<td align=\"center\" class=\"texto_normal\">".$row['FONO_AT3']."</td>";
