...
<hr/>
	...
	<tr>
		...
		<h2>Encuestas Pendientes de Ingreso PENTA</h2>
...
//		echo $strsql;
		...
		if ($result)
		{
			...
			{
				echo "<tr>";
				echo "<td align=\"center\"><a href=\"EditarEncuestaPENTA.php?id_encuesta=".$row['id_encuesta']."&id_formato=".$row['id_formato']."&estado=".$estado."\"><img src=\"../imagenes/lupa.jpg\" border=\"0\" width=\"30\" /></a></td>";
