...
//			include_once("../funciones/combos.php");
			...
			$strsql="select * 
			from qs_encuestas e 
			left join qs_encuesta_1 pe on e.id_encuesta = pe.id_encuesta 
			...
			<form name="ingreso" action="IngresarEncuesta1.php" method="POST" id="ingreso" enctype="multipart/form-data">
			...
			<INPUT type="submit" class="boton" name="enviar" value="GRABAR ENCUESTA" id="enviar" >
			...
			<tr><td>Registro Cliente Enc</td><td><INPUT size="17" type="text" name="registrocli" value="<?PHP echo $row['registrocli']; ?>"></td></tr>
			<tr><td>Rut Cliente</td><td><INPUT size="8" type="text" name="rut_cliente" value="<?PHP echo $row['rut_cliente']; ?>">-<INPUT size="1" type="text" name="dv" value="<?PHP echo $row['dv']; ?>"></td></tr>
			...
			<tr><td>Marca y Modelo</td><td><INPUT size="50" type="text" name="marca_modelo" value="<?PHP echo $row['marca_modelo']; ?>"></td></tr>
			...
			<tr><td>Comuna Siniestro</td><td><INPUT size="50" type="text" name="com_siniestro" value="<?PHP echo $row['ciu_siniestro']; ?>"></td></tr>
			<tr><td>Región Siniestro</td><td><INPUT size="50" type="text" name="reg_siniestro" value="<?PHP echo $row['reg_siniestro']; ?>"></td></tr>
			<tr><td>Fecha Solicitud</td><td><INPUT size="17" type="text" name="fec_solicitud" value="<?PHP echo $row['fec_solicitud']; ?>"></td></tr>
			...
			<tr><td>Teléfono Contacto 1</td><td><INPUT size="50" type="text" name="telefono1" value="<?PHP echo $row['telefono1']; ?>"></td></tr>
			<tr><td>Teléfono Contacto 2</td><td><INPUT size="50" type="text" name="telefono2" value="<?PHP echo $row['telefono2']; ?>"></td></tr>
			<tr><td>Sexo - Categoría</td><td><INPUT size="50" type="text" name="sexo" value="<?PHP echo $row['sexo']; ?>"></td></tr>
			<tr><td>Edad</td><td><INPUT size="17" type="text" name="edad" value="<?PHP echo $row['edad']; ?>"></td></tr>
...
<!-- 			<td>Dirección Asegurado</td><td><INPUT size="45" type="text" name="direccion" value="<?PHP echo $row['direccion']; ?>"></td>
			...
			<tr><td>Nombre Intermediario</td><td><INPUT size="45" type="text" name="nom_intermed" value="<?PHP echo $row['nom_intermed']; ?>"></td><td>Email Part. Intermediario</td><td><INPUT size="45" type="text" name="email_part_intermed" value="<?PHP echo $row['email_part_intermed']; ?>"></td></tr>
 ...
 -->			</table>
			...
			<tr><td colspan="8">1.¿Recuerda que servicio fué el que solicitó ?</td><tr>
			<tr><td>
			<tr><td><INPUT size="150" type="text" name="preg1" value="<?PHP echo $row['preg1']; ?>"></td></tr>
			</td><tr>
			<tr><td colspan="2"><br></td><td></td></tr>
			<tr><td colspan="2"><h3><b>Si el cliente indica que fué grúa, se debe preguntar:</b></h3></td><tr>
			<tr><td colspan="2">a. ¿ Que nota le colocaría a la atención del Liquidador?. </td><tr>
			<tr><td colspan="2">Califique con nota de 1 a 7, donde 1 es muy malo y 7 excelente.</td><tr>
			<tr><td>
				<INPUT type="radio" name="preg1_a" value="1" <?PHP if ($row['preg1_a'] == '1') echo 'checked';?>>1 ...
				<INPUT type="radio" name="preg1_a" value="2" <?PHP if ($row['preg1_a'] == '2') echo 'checked';?>>2 ...
				<INPUT type="radio" name="preg1_a" value="3" <?PHP if ($row['preg1_a'] == '3') echo 'checked';?>>3 ...
				<INPUT type="radio" name="preg1_a" value="4" <?PHP if ($row['preg1_a'] == '4') echo 'checked';?>>4 ...
				<INPUT type="radio" name="preg1_a" value="5" <?PHP if ($row['preg1_a'] == '5') echo 'checked';?>>5 ...
				<INPUT type="radio" name="preg1_a" value="6" <?PHP if ($row['preg1_a'] == '6') echo 'checked';?>>6 ...
				<INPUT type="radio" name="preg1_a" value="7" <?PHP if ($row['preg1_a'] == '7') echo 'checked';?>>7 ...
			</td><tr>
			<tr><td colspan="2"><br></td><td></td></tr>

			<tr><td colspan="8">2.	¿Cuánto tiempo es cliente de Compañía de Seguros <b><?PHP echo $row['nom_intermed'];?></b>?</td><tr>
			<tr><td>
			...
			<tr><td colspan="8">4. ¿Nos podría decir en cual de los siguientes rangos de edad se encuentra usted?</td><tr>
			<tr><td>
			<tr><td><INPUT type="radio" name="preg4" value="18 a 25 años" <?PHP if ($row['preg4'] == '18 a 25 años') echo 'checked';?>>18 a 25 años</td></tr>
			<tr><td><INPUT type="radio" name="preg4" value="26 a 35 años" <?PHP if ($row['preg4'] == '26 a 35 años') echo 'checked';?>>26 a 35 años</td></tr>
			<tr><td><INPUT type="radio" name="preg4" value="36 a 45 años" <?PHP if ($row['preg4'] == '36 a 45 años') echo 'checked';?>>36 a 45 años</td></tr>
			<tr><td><INPUT type="radio" name="preg4" value="46 a 55 años" <?PHP if ($row['preg4'] == '46 a 55 años') echo 'checked';?>>46 a 55 años</td></tr>
			<tr><td><INPUT type="radio" name="preg4" value="56 a 65 años" <?PHP if ($row['preg4'] == '56 a 65 años') echo 'checked';?>>56 a 65 años</td></tr>
			<tr><td><INPUT type="radio" name="preg4" value="66 años y +" <?PHP if ($row['preg4'] == '66 años y +') echo 'checked';?>>66 años y +</td></tr>
			</td><tr>
			<tr><td colspan="2"><br></td><td></td></tr>

			<tr><td><h2>Cliente <?PHP echo $row['rut_cliente'].'-'.$row['dv']; ?> | <?PHP echo $row['nom_cliente']; ?> | <?PHP echo $row['estado']; ?></h2></td></tr>
			<tr><td><h2>B.- Satisfacción General</h2></td></tr>
			<tr><td colspan="2">5.	¿Cuál es el grado de satisfacción general del servicio de <b><?PHP echo $row['siniestro'];?></b> entregado?</td><tr>
			<tr><td colspan="2">Califique con nota de 1 a 7, donde 1 es muy malo y 7 excelente.</td><tr>
			<tr><td>
			...
			<tr><td colspan="8">6.	Considerando que es un servicio de emergencia y considerando su expectativa de respuesta, usted diría que la asistencia brindada fué:</td><tr>
			<tr><td>
			<tr><td><INPUT type="radio" name="preg6" value="Excelente" <?PHP if ($row['preg6'] == 'Excelente') echo 'checked';?>>Excelente</td></tr>
			<tr><td><INPUT type="radio" name="preg6" value="Mucho mejor a lo esperado" <?PHP if ($row['preg6'] == 'Mucho mejor a lo esperado') echo 'checked';?>>Mucho mejor a lo esperado</td></tr>
			<tr><td><INPUT type="radio" name="preg6" value="Algo mejor a lo esperado" <?PHP if ($row['preg6'] == 'Algo mejor a lo esperado') echo 'checked';?>>Algo mejor a lo esperado</td></tr>
			<tr><td><INPUT type="radio" name="preg6" value="Más o menos igual a lo esperado" <?PHP if ($row['preg6'] == 'Más o menos igual a lo esperado') echo 'checked';?>>Más o menos igual a lo esperado</td></tr>
			<tr><td><INPUT type="radio" name="preg6" value="Algo peor a lo esperado" <?PHP if ($row['preg6'] == 'Algo peor a lo esperado') echo 'checked';?>>Algo peor a lo esperado</td></tr>
			<tr><td><INPUT type="radio" name="preg6" value="Mucho peor a lo esperado" <?PHP if ($row['preg6'] == 'Mucho peor a lo esperado') echo 'checked';?>>Mucho peor a lo esperado</td></tr>
			<tr><td><INPUT type="radio" name="preg6" value="No lo sé" <?PHP if ($row['preg6'] == 'No lo sé') echo 'checked';?>>No lo sé</td></tr>
			</td><tr>
			<tr><td colspan="2"><br></td><td></td></tr>

			<tr><td colspan="2">7.	¿Fué expedita la comunicación con la central de asistencia?</td><tr>
			<tr><td colspan="2">Califique con nota de 1 a 7, donde 1 es muy malo y 7 excelente.</td><tr>
			<tr><td>
			...
			<tr><td>
				<INPUT type="radio" name="preg5" value="No Aplica" <?PHP if ($row['preg5'] == 'No Aplica') echo 'checked';?>>No Aplica
			</td><tr>
			<tr><td colspan="2"><br></td><td></td></tr>
			...
			<tr><td><h3>NO APLICA ESTA PREGUNTA SI EL SERVICIO BRINDADO ES VEHÍCULO DE REEMPLAZO</h3></td></tr>
			<tr><td colspan="2">8.	En relación al tiempo de espera del servicio, califique con nota de 1 a 7, donde 1 es muy malo y 7 excelente los siguientes atributos:</td><tr>
			<tr><td colspan="2">a. Tiempo de espera entregados por la central de asistencia</td><tr>
			<tr><td>
			...
			<tr><td colspan="2"><br></td><td></td></tr>
			<tr><td colspan="2">b. Cumplimiento del tiempo de espera entregados por parte del operador</td><tr>
			<tr><td>
			...
			<tr><td colspan="2">9.	En relación al vehículo entregado, califique con nota de 1 a 7, donde 1 es muy malo y 7 excelente, el Estado del Vehículo </td><tr>
			<tr><td colspan="2">Califique con nota de 1 a 7, donde 1 es muy malo y 7 excelente.</td><tr>
			<tr><td>
			...
			<tr><td colspan="2">10.	En relación al trato del prestador del servicio de <b><?PHP echo $row['siniestro'];?></b>, ¿cómo fue el trato del personal que concurrió a asistirlo?</td><tr>
			<tr><td colspan="2">Califique con nota de 1 a 7, donde 1 es muy malo y 7 excelente.</td><tr>
			<tr><td>
			...
			<tr><td colspan="2">11.	En relación a la presentación del prestador del servicio de <b><?PHP echo $row['siniestro'];?></b>, ¿cómo calificaría la presentación del personal que concurrió a asistirlo?</td><tr>
			<tr><td colspan="2">Califique con nota de 1 a 7, donde 1 es muy malo y 7 excelente.</td><tr>
			<tr><td>
			...
			<tr><td colspan="2">Teniendo en cuenta su experiencia reciente con el servicio de asistencia de Compañía de Seguros <b><?PHP echo $row['nom_intermed'];?></b>:</td><tr>
			<tr><td colspan="2"><br></td><td></td></tr>
			<tr><td colspan="8">12.	El servicio brindado, ¿es un atributo positivo como parte de su póliza de seguro <b><?PHP echo $row['ramo'];?></b>?</td><tr>
			<tr><td>
			<tr><td><INPUT type="radio" name="preg12" value="Totalmente de acuerdo" <?PHP if ($row['preg12'] == 'Totalmente de acuerdo') echo 'checked';?>>Totalmente de acuerdo</td></tr>
			<tr><td><INPUT type="radio" name="preg12" value="De acuerdo" <?PHP if ($row['preg12'] == 'De acuerdo') echo 'checked';?>>De acuerdo</td></tr>
			<tr><td><INPUT type="radio" name="preg12" value="En desacuerdo" <?PHP if ($row['preg12'] == 'En desacuerdo') echo 'checked';?>>En desacuerdo</td></tr>
			<tr><td><INPUT type="radio" name="preg12" value="Más o menos igual" <?PHP if ($row['preg12'] == 'Más o menos igual') echo 'checked';?>>Más o menos igual</td></tr>
			<tr><td><INPUT type="radio" name="preg12" value="Totalmente en desacuerdo" <?PHP if ($row['preg12'] == 'Totalmente en desacuerdo') echo 'checked';?>>Totalmente en desacuerdo</td></tr>
			<tr><td><INPUT type="radio" name="preg12" value="No se aplica" <?PHP if ($row['preg12'] == 'No se aplica') echo 'checked';?>>No se aplica</td></tr>
			</td><tr>
			<tr><td colspan="2"><br></td><td></td></tr>

			<tr><td colspan="8">13.	El servicio, ¿atendió bien sus necesidades?</td><tr>
			<tr><td>
			...
			<tr><td colspan="2">14.	Basándose en su experiencia, </td><tr>
			<tr><td colspan="2">a. ¿Usted recomendaría a Compañía de Seguros <b><?PHP echo $row['cod_intermed'];?></b> por su servicio?</td></tr>
			<tr><td><INPUT type="radio" name="preg14_a" value="SI" <?PHP if ($row['preg14_a'] == 'SI') echo 'checked';?>>SI</td></tr>
			<tr><td><INPUT type="radio" name="preg14_a" value="NO" <?PHP if ($row['preg14_a'] == 'NO') echo 'checked';?>>NO</td></tr>
			<tr><td colspan="2"><br></td><td></td></tr>
			...
			<tr><td colspan="2">15.	Hay alguna cosa que le gustaría decirle a Compañía de Seguros <b><?PHP echo $row['nom_intermed'];?></b> sobre su servicio de asistencia, que no le hayamos preguntado?</td><tr>
