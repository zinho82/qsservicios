...
<hr/>
	...
	<tr>
		...
		<h2>Encuestas Pendientes de Ingreso SODIMAC EMPRESAS</h2>
...
//		$strsql="select id_postulante,Nombres,ape_paterno,ape_materno from cv_postulantes where estado=1 order by Nombres";
		...
		$strsql="select distinct cod_carga, a.id_formato, formato, id_encuesta, date_format(a.fec_ingreso,'%d-%m-%Y') as fec_ingreso, 
				rut_dv, Cliente, Mail, CELULAR_CONTACTO, TELEFONO_TRABAJO_CONTACTO, TELEFONO_CASA_CONTACTO, FONO_AT4, FONO_AT5, Num_Celular, 
				e.estado 
				from qs_encuestascli_sodimac_emp a 
...
//		echo $strsql;
		...
		if ($result)
		{
			...
			echo "<th align=\"center\" class=\"texto_normal\">rut_dv</th>";
			echo "<th align=\"center\" class=\"texto_normal\">Cliente</th>";
			echo "<th align=\"center\" class=\"texto_normal\">E-mail Contacto en Empresa Cliente</th>";
			echo "<th align=\"center\" class=\"texto_normal\">Celular Contacto en Empresa Cliente</th>";
			echo "<th align=\"center\" class=\"texto_normal\">Teléfono Trabajo Contacto en Empresa Cliente</th>";
			echo "<th align=\"center\" class=\"texto_normal\">Teléfono Casa Contacto en Empresa Cliente</th>";
			echo "<th align=\"center\" class=\"texto_normal\">FONO_AT4</th>";
			echo "<th align=\"center\" class=\"texto_normal\">FONO_AT5</th>";
			echo "<th align=\"center\" class=\"texto_normal\">Celular</th>";
			echo "<th align=\"center\" class=\"rounded-q4\">Estado</th></thead></tr><tbody>";
			while($row = mysql_fetch_array($result))
			{
				echo "<tr>";
				echo "<td align=\"center\"><a href=\"EditarEncuestaSODI_EMP.php?id_encuesta=".$row['id_encuesta']."&id_formato=".$row['id_formato']."&estado=".$estado."\"><img src=\"../imagenes/lupa.jpg\" border=\"0\" width=\"30\" /></a></td>";
				...
				echo "<td align=\"center\" class=\"texto_normal\">".$row['rut_dv']."</td>";
				echo "<td align=\"center\" class=\"texto_normal\">".$row['Cliente']."</td>";
				echo "<td align=\"center\" class=\"texto_normal\">".$row['Mail']."</td>";
				echo "<td align=\"center\" class=\"texto_normal\">".$row['CELULAR_CONTACTO']."</td>";
				echo "<td align=\"center\" class=\"texto_normal\">".$row['TELEFONO_TRABAJO_CONTACTO']."</td>";
				echo "<td align=\"center\" class=\"texto_normal\">".$row['TELEFONO_CASA_CONTACTO']."</td>";
				echo "<td align=\"center\" class=\"texto_normal\">".$row['FONO_AT4']."</td>";
				echo "<td align=\"center\" class=\"texto_normal\">".$row['FONO_AT5']."</td>";
				echo "<td align=\"center\" class=\"texto_normal\">".$row['Num_Celular']."</td>";
				echo "<td align=\"center\" class=\"texto_normal\">".$row['estado']."</td></tr>";			}
			echo "<tfoot><tr><td colspan=\"14\" class=\"rounded-foot-left\"></td><td class=\"rounded-foot-right\">&nbsp;</td></tr></tfoot>";
			echo "</tbody></table>";
		}
		?>
		</td>
