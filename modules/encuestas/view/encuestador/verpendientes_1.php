...
<hr/>
	...
	<tr>
		...
		<h2>Encuestas Pendientes de Ingreso</h2>
...
//		$strsql="select id_postulante,Nombres,ape_paterno,ape_materno from cv_postulantes where estado=1 order by Nombres";
		...
		$strsql="select distinct cod_carga, a.id_formato, formato, id_encuesta, date_format(a.fec_ingreso,'%d-%m-%Y') as fec_ingreso, 
				rut_cliente, dv, nom_cliente, registrocli, 
				e.estado 
				from qs_encuestas a
		...
		if ($result)
		{
			...
			echo "<th align=\"center\" class=\"texto_normal\">Registro</th>";
			...
			{
				echo "<tr>";
				echo "<td align=\"center\"><a href=\"EditarEncuesta".$row['id_formato'].".php?id_encuesta=".$row['id_encuesta']."&id_formato=".$row['id_formato']."&estado=".$estado."\"><img src=\"../imagenes/lupa.jpg\" border=\"0\" width=\"30\" /></a></td>";
				...
				echo "<td align=\"center\" class=\"texto_normal\">".$row['registrocli']."</td>";
