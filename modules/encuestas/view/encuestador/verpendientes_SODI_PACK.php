...
<hr/>
	...
	<tr>
		...
		<h2>Encuestas Pendientes de Ingreso SODIMAC PACK</h2>
...
//		$strsql="select id_postulante,Nombres,ape_paterno,ape_materno from cv_postulantes where estado=1 order by Nombres";
		...
		$strsql="select distinct cod_carga, a.id_formato, formato, id_encuesta, date_format(a.fec_ingreso,'%d-%m-%Y') as fec_ingreso, 
				Tienda, Proyecto, FecPago, NombreCliente, Rut, Fono, Calle, Numero, Comuna, Ciudad, MesPagoPack, Year, 
				e.estado 
				from qs_encuestascli_sodimac_pack a 
...
//		echo $strsql;
		...
		if ($result)
		{
			...
			echo "<th align=\"center\" class=\"texto_normal\">Tienda</th>";
			echo "<th align=\"center\" class=\"texto_normal\">Proyecto</th>";
			echo "<th align=\"center\" class=\"texto_normal\">FecPago</th>";
			echo "<th align=\"center\" class=\"texto_normal\">NombreCliente</th>";
			echo "<th align=\"center\" class=\"texto_normal\">Rut</th>";
			echo "<th align=\"center\" class=\"texto_normal\">Fono</th>";
			echo "<th align=\"center\" class=\"texto_normal\">Comuna</th>";
			echo "<th align=\"center\" class=\"texto_normal\">MesPagoPack</th>";
			echo "<th align=\"center\" class=\"texto_normal\">Year</th>";
			echo "<th align=\"center\" class=\"rounded-q4\">Estado</th></thead></tr><tbody>";
			while($row = mysql_fetch_array($result))
			{
				echo "<tr>";
				echo "<td align=\"center\"><a href=\"EditarEncuestaSODI_PACK.php?id_encuesta=".$row['id_encuesta']."&id_formato=".$row['id_formato']."&estado=".$estado."\"><img src=\"../imagenes/lupa.jpg\" border=\"0\" width=\"30\" /></a></td>";
				...
				echo "<td align=\"center\" class=\"texto_normal\">".$row['Tienda']."</td>";
				echo "<td align=\"center\" class=\"texto_normal\">".$row['Proyecto']."</td>";
				echo "<td align=\"center\" class=\"texto_normal\">".$row['FecPago']."</td>";
				echo "<td align=\"center\" class=\"texto_normal\">".$row['NombreCliente']."</td>";
				echo "<td align=\"center\" class=\"texto_normal\">".$row['Rut']."</td>";
				echo "<td align=\"center\" class=\"texto_normal\">".$row['Fono']."</td>";
				echo "<td align=\"center\" class=\"texto_normal\">".$row['Comuna']."</td>";
				echo "<td align=\"center\" class=\"texto_normal\">".$row['MesPagoPack']."</td>";
				echo "<td align=\"center\" class=\"texto_normal\">".$row['Year']."</td>";
