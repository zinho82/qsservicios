...
-->
	...
	<tr>
		...
		<td valign="top">
			...
			$strsql="select * 
			from qs_encuestascli_sodimac_esp e 
			left join qs_encuesta_sodimac_esp pe on e.id_encuesta = pe.id_encuesta 
...
//			print $strsql;
			...
			?>
			<form name="ingreso" action="IngresarEncuestaSODI_ESP.php" method="POST" id="ingreso" enctype="multipart/form-data">
			...
			<div class="field">
 			...
 			<table>
			<tr><td colspan="2"><h2>Inicio Encuesta SODIMAC ESPECIALISTA</h2></td></tr>
			...
			<tr>
				...
				<select name="status3_llamada" size="15" >
					...
					<option value="1.a.iv. NO contesta encuesta" >1.a.iv. NO contesta encuesta</option>
					<option value="1.a.vi. Cliente molesto con Llamada">1.a.vi. Cliente molesto con Llamada</option>
					<option value="1.a.vii. Volver a Llamar" >1.a.vii. Volver a Llamar</option>
<!-- 					<option value="1.a.viii. Renuncio al seguro" >1.a.viii. Renuncio al seguro</option>
 ...
 -->				</select>
			...
			<tr><td colspan="2">1.	¿Ha comprado algún producto para la construcción y/o de mejoramiento para el hogar, como materiales de construcción, pinturas, artículos de baño y cocina, pisos, muebles y/o cualquier otro producto para ser utilizado, en su actividad laboral en los últimos meses?</td><tr>
			...
			<tr><td colspan="2">3.	¿Usted se dedica a <?PHP echo $row['Sexo']; ?>?</td><tr>
			<tr><td><INPUT type="radio" name="preg3_0_1" value="SI" <?PHP if ($row['preg3_0_1'] == 'SI') echo 'checked';?>>SI</td></tr>
			<tr><td><INPUT type="radio" name="preg3_0_1" value="NO" <?PHP if ($row['preg3_0_1'] == 'NO') echo 'checked';?>>
			NO <span class="Estilo1">- ¿ Cual ?: <INPUT size="100" type="text" name="preg3_0_2" value="<?PHP echo $row['preg3_0_2']; ?>"> </span> </td>
			</tr>
			<tr><td colspan="2"><br /></td></tr>
			

			<tr><td colspan="2">2.	¿En qué empresas realizó la compra?</td><tr>
			...
			<tr><td colspan="2">3.  En una escala de 0 a 10, donde “0” significa “no recomendaría en lo absoluto” y “10” significa “definitivamente recomendaría”, ¿qué tanto recomendaría a [Empresa 1] a un amigo o colega?</td><tr>
			<tr><td>
			...
			<tr><td colspan="2">4.	¿Cuáles son las razones de esta nota? [escribir respuesta textual] [si responde 0 a 8 y da razones positivas, preguntar qué falta para que esa nota sea 9 o 10]</td><tr>
			...
			<tr><td colspan="2">5.	En una escala de 0 a 10, donde “0” significa “no recomendaría en lo absoluto” y “10” significa “definitivamente recomendaría”, ¿qué tanto recomendaría a [Empresa 2] a un amigo o colega?</td><tr>
			<tr><td>
			...
			<tr><td colspan="2">6.	¿Cuáles son las razones de esta nota? [escribir respuesta textual] [si responde 0 a 8 y da razones positivas, preguntar qué falta para que esa nota sea 9 o 10]</td><tr>
			...
			<tr><td colspan="2">7.	¿En qué ciudad realiza habitualmente sus compras de productos para la construcción y/o de mejoramiento para el hogar, como herramientas, muebles, decoración y línea blanca, con fines profesionales?</td><tr>
			<tr><td>Ciudad: <INPUT size="60" type="text" name="preg7" value="<?PHP echo $row['preg7']; ?>"></td></tr>
			<tr><td colspan="2"><br /></td></tr>

			<tr><td colspan="2">8.	Ciudad en que está cliente al momento de realizar la encuesta: </td><tr>
