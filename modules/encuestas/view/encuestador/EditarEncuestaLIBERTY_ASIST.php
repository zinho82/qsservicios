...
//			include_once("../funciones/combos.php");
			...
			$strsql="select * 
			from qs_encuestascli_liberty_asist e 
			left join qs_encuesta_liberty_asist pe on e.id_encuesta = pe.id_encuesta 
			...
			<form name="ingreso" action="IngresarEncuestaLIBERTY_ASIST.php" method="POST" id="ingreso" enctype="multipart/form-data">
...
<?PHP 
			...
			VALUES (".$_SESSION['s_id_acceso'].",".$_SESSION['s_id_acceso'].", NOW() , 'Comienza Ingreso Encuesta ASISTENCIAS LIBERTY|. Encuestador ".$_SESSION['s_id_acceso']."')";			
			query_bd($strsql);
?> 			
