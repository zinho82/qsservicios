...
if ($estado2==8)
{
	$strsql="select * from qs_encuestascli_liberty_asist 
	...
	if ($result)
	{
		...
		$url="EditarEncuestaLIBERTY_ASIST.php?id_encuesta=".$row['id_encuesta']."&id_formato=".$id_formato."&estado=".$estado;
		Header("Location: $url");	
	}
	else
	{
		$url="EditarEncuestaLIBERTY_ASIST.php?id_encuesta=".$id_encuesta."&id_formato=".$id_formato."&estado=".$estado;
		Header("Location: $url");	
	}
}
...
if(isset($_POST['preg7_d'])) $preg7_d=$_POST['preg7_d'];
...
if(isset($_POST['preg13_area1'])) $preg13_area1=$_POST['preg13_area1'];
if(isset($_POST['preg13_causa1'])) $preg13_causa1=$_POST['preg13_causa1'];
if(isset($_POST['preg13_area2'])) $preg13_area2=$_POST['preg13_area2'];
if(isset($_POST['preg13_causa2'])) $preg13_causa2=$_POST['preg13_causa2'];
if(isset($_POST['preg13_area3'])) $preg13_area3=$_POST['preg13_area3'];
if(isset($_POST['preg13_causa3'])) $preg13_causa3=$_POST['preg13_causa3'];
...
$StrSql="UPDATE qs_encuestascli_liberty_asist set 
...
$strsql="select * from qs_encuesta_liberty_asist where id_encuesta = '".$id_encuesta."'";
$result=consulta_bd($strsql);

if ($result)
{
	$StrSql="UPDATE qs_encuesta_liberty_asist set 
	preg1_a = '".$preg1_a."', 
	preg1_b = '".$preg1_b."', 
	preg1_c = '".$preg1_c."', 
	preg2 = '".$preg2."', 
	...
	preg12 = '".$preg12."', 
	preg13 = '".$preg13."', 
	preg13_area1 = '".$preg13_area1."', 
	preg13_causa1 = '".$preg13_causa1."', 
	preg13_area2 = '".$preg13_area2."', 
	preg13_causa2 = '".$preg13_causa2."', 
	preg13_area3 = '".$preg13_area3."', 
	preg13_causa3 = '".$preg13_causa3."', 
	preg14 = '".$preg14."', 
	preg15 = '".$preg15."', 
	preg16 = '".$preg16."', 
	preg17 = '".$preg17."',
...
{
	$StrSql="INSERT INTO qs_encuesta_liberty_asist (id_encuesta,
	preg1_a, preg1_b, preg1_c, preg2, preg3, preg4, preg5, preg5_1, preg6_a, preg6_b, preg7_a, preg7_b, preg7_c, preg7_d, preg8, preg8_1, preg9, preg9_1, preg10, preg11, preg12, preg13, preg13_area1, preg13_causa1, preg13_area2, preg13_causa2, preg13_area3, preg13_causa3, preg14, preg15, preg16, preg17 , preg18  
	) VALUES (
	'".$id_encuesta."',
	'".$preg1_a."', 
	'".$preg1_b."', 
...
if(query_bd($StrSql))
{
		$StrSql="UPDATE qs_encuestascli_liberty_asist set estado = ".$estado2." 
		...
		if ($_POST['enviar']=='POSTERGAR ENCUESTA') {
			if ($num_post >= 6) {
				$StrSql="UPDATE qs_encuestascli_liberty_asist set estado = 9, num_post = ".$num_post."  + 1  
				where id_encuesta = ".$id_encuesta;
				query_bd($StrSql);
			}
			else
			{
				$StrSql="UPDATE qs_encuestascli_liberty_asist set fec_postergada = '".$fec_postergada_format."'  
				, num_post = ".$num_post."  + 1 
				where id_encuesta = ".$id_encuesta;
				query_bd($StrSql);
			}
		...
		VALUES (".$_SESSION['s_id_acceso'].",".$_SESSION['s_id_acceso'].", NOW() , 'Encuesta ASISTENCIAS LIBERTY Ingresada por encuestador ".$_SESSION['s_id_acceso']."')";
		query_bd($StrSql);
