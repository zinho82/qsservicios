...
$conn = new config();
 $sql = "insert into " . $_SESSION['campana']['bd'] . ".cliente_respuestas values(" . $_POST['IdCli'] . ",'" . date('Y-m-d G:i:s') . "'," . $_POST['Dim1'] . "," . $_POST['Area1'] . ",'" . $_POST['Dim2'] . "','" . $_POST['Area2'] . "','" . $_POST['Dim3'] . "','" . $_POST['Area3'] . "',null,'" . $_POST['Clasi1'] . "','" . $_POST['Clasi2'] . "','" . $_POST['Clasi3'] . "')";
